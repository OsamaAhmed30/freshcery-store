<?php 
    ...
    require_once($_SERVER['DOCUMENT_ROOT']."/Freshcery/config/config.php");
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a href="<?php echo APPURL?>/products/shop.php" class="nav-link">Shop</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="avatar-header"><img src='<?php echo $_SESSION['image'] ?  APPURL."/assets/img/user/".$_SESSION['image']:  APPURL."/assets/img/user/user-1.avif"; ?>'></div>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo APPURL?>/products/cart.php" class="nav-link" data-toggle="" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-shopping-basket"></i> <span class="badge badge-primary badge_number" id="cart_count"><?php echo $carts_count ?></span>
                            </a>
